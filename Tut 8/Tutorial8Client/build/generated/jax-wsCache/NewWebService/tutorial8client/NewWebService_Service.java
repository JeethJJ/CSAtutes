 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://server/", wsdlLocation = "http://localhost:8080/Tutorial8WebService/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/Tutorial8WebService/NewWebService?wsdl");
